...
type Bible struct {
	...
	BiblePurpose []BiblePurpose `xml:"b354,omitempty" json:",omitempty"`
	...
	BibleTextFeature []BibleTextFeature `xml:"b357,omitempty" json:",omitempty"`
}
...
type Conference struct {
	...
	ConferenceSponsor []ConferenceSponsor `xml:"conferencesponsor,omitempty" json:",omitempty"`
	Website []Website `xml:"website,omitempty" json:",omitempty"`
}
...
type ContainedItem struct {
	...
	ProductIdentifier []ProductIdentifier `xml:"productidentifier,omitempty" json:",omitempty"`
	ProductForm ProductForm `xml:"b012,omitempty" json:",omitempty"`
	ProductFormDetail []ProductFormDetail `xml:"b333,omitempty" json:",omitempty"`
	ProductFormFeature []ProductFormFeature `xml:"productformfeature,omitempty" json:",omitempty"`
	BookFormDetail []BookFormDetail `xml:"b013,omitempty" json:",omitempty"`
	...
	ProductContentType []ProductContentType `xml:"b385,omitempty" json:",omitempty"`
	ItemQuantity string `xml:"b015,omitempty" json:",omitempty"`
}

// ContentItem is not documented.
type ContentItem struct {
	Title []Title `xml:"title,omitempty" json:",omitempty"`
	...
	Website []Website `xml:"website,omitempty" json:",omitempty"`
	WorkIdentifier []WorkIdentifier `xml:"workidentifier,omitempty" json:",omitempty"`
	Subject []Subject `xml:"subject,omitempty" json:",omitempty"`
	PersonAsSubject []PersonAsSubject `xml:"personassubject,omitempty" json:",omitempty"`
	CorporateBodyAsSubject []string `xml:"b071,omitempty" json:",omitempty"`
	PlaceAsSubject []string `xml:"b072,omitempty" json:",omitempty"`
	OtherText []OtherText `xml:"othertext,omitempty" json:",omitempty"`
	MediaFile []MediaFile `xml:"mediafile,omitempty" json:",omitempty"`
	Contributor []Contributor `xml:"contributor,omitempty" json:",omitempty"`
...
type Contributor struct {
	...
	LanguageCode []LanguageCode `xml:"b252,omitempty" json:",omitempty"`
	UnnamedPersons UnnamedPersons `xml:"b249,omitempty" json:",omitempty"`
	CorporateName string `xml:"b047,omitempty" json:",omitempty"`
	PersonNameIdentifier []PersonNameIdentifier `xml:"personnameidentifier,omitempty" json:",omitempty"`
	PersonName string `xml:"b036,omitempty" json:",omitempty"`
	PersonNameInverted string `xml:"b037,omitempty" json:",omitempty"`
	Name []Name `xml:"name,omitempty" json:",omitempty"`
	...
	PersonDate []PersonDate `xml:"persondate,omitempty" json:",omitempty"`
	ProfessionalAffiliation []ProfessionalAffiliation `xml:"professionalaffiliation,omitempty" json:",omitempty"`
	...
	RegionCode []string `xml:"b398,omitempty" json:",omitempty"`
}
...
type Header struct {
	...
	SenderIdentifier []SenderIdentifier `xml:"senderidentifier,omitempty" json:",omitempty"`
	...
	AddresseeIdentifier []AddresseeIdentifier `xml:"addresseeidentifier,omitempty" json:",omitempty"`
...
type MainSeriesRecord struct {
	...
	Contributor []Contributor `xml:"contributor,omitempty" json:",omitempty"`
	OtherText []OtherText `xml:"othertext,omitempty" json:",omitempty"`
	Publisher []Publisher `xml:"publisher,omitempty" json:",omitempty"`
...
type MarketRepresentation struct {
	...
	AgentIdentifier []AgentIdentifier `xml:"agentidentifier,omitempty" json:",omitempty"`
	...
	TelephoneNumber []string `xml:"j270,omitempty" json:",omitempty"`
	FaxNumber []string `xml:"j271,omitempty" json:",omitempty"`
	EmailAddress []string `xml:"j272,omitempty" json:",omitempty"`
	Website []Website `xml:"website,omitempty" json:",omitempty"`
	...
	MarketDate []MarketDate `xml:"marketdate,omitempty" json:",omitempty"`
}
...
type NewSupplier struct {
	...
	SupplierIdentifier []SupplierIdentifier `xml:"supplieridentifier,omitempty" json:",omitempty"`
...
type NotForSale struct {
	...
	RightsCountry []CountryCodeList `xml:"b090,omitempty" json:",omitempty"`
	ISBN string `xml:"b004,omitempty" json:",omitempty"`
	EAN13 string `xml:"b005,omitempty" json:",omitempty"`
	ProductIdentifier []ProductIdentifier `xml:"productidentifier,omitempty" json:",omitempty"`
...
type ONIXMessage struct {
	...
	Product []Product `xml:"product,omitempty" json:",omitempty"`
	MainSeriesRecord []MainSeriesRecord `xml:"mainseriesrecord,omitempty" json:",omitempty"`
	SubSeriesRecord []SubSeriesRecord `xml:"subseriesrecord,omitempty" json:",omitempty"`
}
...
type Price struct {
	...
	BatchBonus []BatchBonus `xml:"batchbonus,omitempty" json:",omitempty"`
	ClassOfTrade string `xml:"j149,omitempty" json:",omitempty"`
	BICDiscountGroupCode string `xml:"j150,omitempty" json:",omitempty"`
	DiscountCoded []DiscountCoded `xml:"discountcoded,omitempty" json:",omitempty"`
...
type Product struct {
	...
	Measure []Measure `xml:"measure,omitempty" json:",omitempty"`
	...
	RelatedProduct []RelatedProduct `xml:"relatedproduct,omitempty" json:",omitempty"`
	OutOfPrintDate string `xml:"h134,omitempty" json:",omitempty"`
	SupplyDetail []SupplyDetail `xml:"supplydetail,omitempty" json:",omitempty"`
	MarketRepresentation []MarketRepresentation `xml:"marketrepresentation,omitempty" json:",omitempty"`
	...
	ReprintDetail []string `xml:"k309,omitempty" json:",omitempty"`
	...
	Series []Series `xml:"series,omitempty" json:",omitempty"`
	NoSeries NoSeries `xml:"n338,omitempty" json:",omitempty"`
	Set []Set `xml:"set,omitempty" json:",omitempty"`
	Title []Title `xml:"title,omitempty" json:",omitempty"`
	DistinctiveTitle string `xml:"b028,omitempty" json:",omitempty"`
	...
	FormerTitle []string `xml:"b033,omitempty" json:",omitempty"`
	...
	Conference []Conference `xml:"conference,omitempty" json:",omitempty"`
	ConferenceRole ConferenceRole `xml:"b051,omitempty" json:",omitempty"`
	...
	EditionTypeCode []EditionTypeCode `xml:"b056,omitempty" json:",omitempty"`
	...
	Prize []Prize `xml:"prize,omitempty" json:",omitempty"`
	Publisher []Publisher `xml:"publisher,omitempty" json:",omitempty"`
	ImprintName string `xml:"b079,omitempty" json:",omitempty"`
	Imprint []Imprint `xml:"imprint,omitempty" json:",omitempty"`
	PublisherName string `xml:"b081,omitempty" json:",omitempty"`
	CopyrightStatement []CopyrightStatement `xml:"copyrightstatement,omitempty" json:",omitempty"`
	CopyrightYear string `xml:"b087,omitempty" json:",omitempty"`
	Barcode []Barcode `xml:"b246,omitempty" json:",omitempty"`
	...
	TradeCategory TradeCategory `xml:"b384,omitempty" json:",omitempty"`
	ProductContentType []ProductContentType `xml:"b385,omitempty" json:",omitempty"`
	ContainedItem []ContainedItem `xml:"containeditem,omitempty" json:",omitempty"`
	ProductClassification []ProductClassification `xml:"productclassification,omitempty" json:",omitempty"`
	...
	LanguageOfText []LanguageOfText `xml:"b059,omitempty" json:",omitempty"`
	OriginalLanguage OriginalLanguage `xml:"b060,omitempty" json:",omitempty"`
	Language []Language `xml:"language,omitempty" json:",omitempty"`
	...
	Extent []Extent `xml:"extent,omitempty" json:",omitempty"`
	NumberOfIllustrations string `xml:"b125,omitempty" json:",omitempty"`
	IllustrationsNote string `xml:"b062,omitempty" json:",omitempty"`
	Illustrations []Illustrations `xml:"illustrations,omitempty" json:",omitempty"`
	MapScale []string `xml:"b063,omitempty" json:",omitempty"`
	MainSubject []MainSubject `xml:"mainsubject,omitempty" json:",omitempty"`
	Subject []Subject `xml:"subject,omitempty" json:",omitempty"`
	PersonAsSubject []PersonAsSubject `xml:"personassubject,omitempty" json:",omitempty"`
	CorporateBodyAsSubject []string `xml:"b071,omitempty" json:",omitempty"`
	PlaceAsSubject []string `xml:"b072,omitempty" json:",omitempty"`
	AudienceCode []AudienceCode `xml:"b073,omitempty" json:",omitempty"`
	Audience []Audience `xml:"audience,omitempty" json:",omitempty"`
	USSchoolGrade string `xml:"b189,omitempty" json:",omitempty"`
	InterestAge string `xml:"b190,omitempty" json:",omitempty"`
	AudienceRange []AudienceRange `xml:"audiencerange,omitempty" json:",omitempty"`
	AudienceDescription string `xml:"b207,omitempty" json:",omitempty"`
	Complexity []Complexity `xml:"complexity,omitempty" json:",omitempty"`
	Annotation Annotation `xml:"d100,omitempty" json:",omitempty"`
	MainDescription MainDescription `xml:"d101,omitempty" json:",omitempty"`
	OtherText []OtherText `xml:"othertext,omitempty" json:",omitempty"`
	ReviewQuote []ReviewQuote `xml:"e110,omitempty" json:",omitempty"`
	MediaFile []MediaFile `xml:"mediafile,omitempty" json:",omitempty"`
	ProductWebsite []ProductWebsite `xml:"productwebsite,omitempty" json:",omitempty"`
	ContentItem []ContentItem `xml:"contentitem,omitempty" json:",omitempty"`
	CityOfPublication []string `xml:"b209,omitempty" json:",omitempty"`
	CountryOfPublication CountryOfPublication `xml:"b083,omitempty" json:",omitempty"`
	CopublisherName []string `xml:"b084,omitempty" json:",omitempty"`
	SponsorName []string `xml:"b085,omitempty" json:",omitempty"`
	...
	SalesRights []SalesRights `xml:"salesrights,omitempty" json:",omitempty"`
	NotForSale []NotForSale `xml:"notforsale,omitempty" json:",omitempty"`
	SalesRestriction []SalesRestriction `xml:"salesrestriction,omitempty" json:",omitempty"`
...
type Reissue struct {
	...
	Price []Price `xml:"price,omitempty" json:",omitempty"`
	MediaFile []MediaFile `xml:"mediafile,omitempty" json:",omitempty"`
}
...
type ReligiousText struct {
	...
	ReligiousTextFeature []ReligiousTextFeature `xml:"religioustextfeature,omitempty" json:",omitempty"`
}
...
type SalesRestriction struct {
	...
	SalesOutlet []SalesOutlet `xml:"salesoutlet,omitempty" json:",omitempty"`
...
type SalesRights struct {
	RightsTerritory TerritoryCodeList `xml:"b388,omitempty" json:",omitempty"`
	RightsRegion []RightsRegion `xml:"b091,omitempty" json:",omitempty"`
	RightsCountry []CountryCodeList `xml:"b090,omitempty" json:",omitempty"`
...
type Series struct {
	...
	SeriesIdentifier []SeriesIdentifier `xml:"seriesidentifier,omitempty" json:",omitempty"`
	Contributor []Contributor `xml:"contributor,omitempty" json:",omitempty"`
...
type Stock struct {
	...
	OnOrderDetail []OnOrderDetail `xml:"onorderdetail,omitempty" json:",omitempty"`
}
...
type SupplyDetail struct {
	...
	Stock []Stock `xml:"stock,omitempty" json:",omitempty"`
	...
	SupplyToRegion []SupplyToRegion `xml:"j139,omitempty" json:",omitempty"`
	SupplyToCountry []CountryCodeList `xml:"j138,omitempty" json:",omitempty"`
	SupplyToCountryExcluded []CountryCodeList `xml:"j140,omitempty" json:",omitempty"`
...
type TextItem struct {
	PageRun []PageRun `xml:"pagerun,omitempty" json:",omitempty"`
	FirstPageNumber string `xml:"b286,omitempty" json:",omitempty"`
	LastPageNumber string `xml:"b287,omitempty" json:",omitempty"`
	TextItemType TextItemType `xml:"b290"`
	TextItemIdentifier []TextItemIdentifier `xml:"textitemidentifier,omitempty" json:",omitempty"`
	NumberOfPages string `xml:"b061,omitempty" json:",omitempty"`
}
